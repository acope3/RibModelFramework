#include "Genome.h"
#include "ROCParameter.h"//these two files must be included here to get at the implimentation
#include "ROCModel.h" 		//for simulateGenome. They cannot be included in the header file. See genome.h for
