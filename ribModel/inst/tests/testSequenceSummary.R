...
test_that("Index to Codon", {
  ...
  expect_equal(codonToIndex(0, TRUE), "GCA")) 
  expect_equal(codonToIndex(1, TRUE), "GCC"))
  expect_equal(codonToIndex(2, TRUE), "GCG"))
  expect_equal(codonToIndex(3, TRUE), "TGC"))
  expect_equal(codonToIndex(4, TRUE), "GAC"))
  expect_equal(codonToIndex(5, TRUE), "GAA"))
  expect_equal(codonToIndex(6, TRUE), "TTC"))
  expect_equal(codonToIndex(7, TRUE), "GGA"))
  expect_equal(codonToIndex(8, TRUE), "GGC"))
  expect_equal(codonToIndex(9, TRUE), "GGG"))
  expect_equal(codonToIndex(10, TRUE), "CAC"))
  expect_equal(codonToIndex(11, TRUE), "ATA"))
  expect_equal(codonToIndex(12, TRUE), "ATC"))
  expect_equal(codonToIndex(13, TRUE), "AAA"))
  expect_equal(codonToIndex(14, TRUE), "CTA"))
  expect_equal(codonToIndex(15, TRUE), "CTC"))
  expect_equal(codonToIndex(16, TRUE), "CTG"))
  expect_equal(codonToIndex(17, TRUE), "CTT"))
  expect_equal(codonToIndex(18, TRUE), "TTA"))
  expect_equal(codonToIndex(19, TRUE), "AAC"))
  expect_equal(codonToIndex(20, TRUE), "CCA"))
  expect_equal(codonToIndex(21, TRUE), "CCC"))
  expect_equal(codonToIndex(22, TRUE), "CCG"))
  expect_equal(codonToIndex(23, TRUE), "CAA"))
  expect_equal(codonToIndex(24, TRUE), "AGA"))
  expect_equal(codonToIndex(25, TRUE), "AGG"))
  expect_equal(codonToIndex(26, TRUE), "CGA"))
  expect_equal(codonToIndex(27, TRUE), "CGC"))
  expect_equal(codonToIndex(28, TRUE), "CGG"))
  expect_equal(codonToIndex(29, TRUE), "TCA"))
  expect_equal(codonToIndex(30, TRUE), "TCC"))
  expect_equal(codonToIndex(31, TRUE), "TCG"))
  expect_equal(codonToIndex(32, TRUE), "ACA"))
  expect_equal(codonToIndex(33, TRUE), "ACC"))
  expect_equal(codonToIndex(34, TRUE), "ACG"))
  expect_equal(codonToIndex(35, TRUE), "GTA"))
  expect_equal(codonToIndex(36, TRUE), "GTC"))
  expect_equal(codonToIndex(37, TRUE), "GTG"))
  expect_equal(codonToIndex(38, TRUE), "TAC"))
  expect_equal(codonToIndex(39, TRUE), "AGC"))
})
