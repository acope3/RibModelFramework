...
#ifdef _OPENMP
//#ifndef __APPLE__
#pragma #pragma omp parallel for private(gene,mutation, selection, curAA) reduction(+:lpr_sphi,lpr_a1)
#endif
	...
	//my_print("A1 current: % A1 proposed % LogLikelihoodRatio %\n",a1_current,a1_proposed,lpr_a1);
}
