...
pdf("Skluyveri_Genome_allUnique_startCSP_VGAM_startPhi_SCUO_adaptSphi_True.pdf", width = 11, height = 12)
plot(mcmc)
...
obs.phi <- log10(read.table("../ribModel/data/twoMixtures/simulatedKluyveri_full_phi.csv", sep=",", header=T)[, 2])
